...
with bar_graph:
		...
		image = Image.open(r'C:\Users\DeekshaTiwari\OneDrive - TheMathCompany Private Limited\Desktop\streamlit_multi_page_app\data\prod_reddit_Vegan_serums.jpeg')
		st.image(image, caption='Wordcloud')

		st.header("Engagement Score of Different Ingredients")
		csv = pd.read_csv(r'C:\Users\DeekshaTiwari\OneDrive - TheMathCompany Private Limited\Desktop\streamlit_multi_page_app\data\screen3ingredientdata.csv')
		df = pd.DataFrame(csv)
		#st.dataframe(df)
		csv1 = pd.read_csv(r'C:\Users\DeekshaTiwari\OneDrive - TheMathCompany Private Limited\Desktop\streamlit_multi_page_app\data\ingredienttimeseries.csv')
